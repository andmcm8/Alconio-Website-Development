    ...
    <footer class="bg-[#02010A] pt-24 pb-12 px-6 font-display border-t border-white/5 relative z-10">
        <div class="max-w-7xl mx-auto w-[95%]">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 mb-24">
                ...
                <!-- Left Column (Contact & Vision) - takes up 6 cols -->
                ...
                <div class="lg:col-span-2">
                    ...
                    <ul class="flex flex-col gap-4 text-white/70 text-sm font-medium">
                        <li><a href="about.html" class="hover:text-white transition-colors">The Mission</a></li>
                        <li><a href="our-work.html" class="hover:text-white transition-colors">Project Portfolio</a></li>
                        <li><a href="pricing.html" class="hover:text-white transition-colors">System Tiers</a></li>
                        <li><a href="dashboard_signin.html" class="hover:text-white transition-colors flex items-center gap-2">Client Portal <span class="size-1.5 rounded-full bg-[#1E51FF] animate-pulse"></span></a></li>
                    </ul>
                </div>

                <!-- Right Column (Information) - takes up 2 cols -->
                <div class="lg:col-span-2">
                    <h5 class="text-[#1E51FF] text-[10px] font-bold uppercase tracking-[0.2em] mb-6">Architecture</h5>
                    <ul class="flex flex-col gap-4 text-white/70 text-sm font-medium">
                        <li><a href="services.html" class="hover:text-white transition-colors">Design Lab</a></li>
                        <li><a href="services.html" class="hover:text-white transition-colors">Engineering</a></li>
                        <li><a href="services.html" class="hover:text-white transition-colors">AI Protocol</a></li>
                    </ul>
                </div>
            </div>
    ...
    if '<footer' in content and '</body>' in content:
        ...
        if new_content != content:
            with open(file, 'w', encoding='utf-8') as f:
                f.write(new_content)
                print(f"Re-updated footer in {file}")

print("V2 footer update complete.")
